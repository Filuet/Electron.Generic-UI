...
export const unDispensedProductsEmailEndpoint = '/api/email/undispensed';
export const notTakenProductsEmailEndpoint = '/api/email/nottaken';
export const machineInoperableEmailEndpoint = '/api/email/inoperable';
